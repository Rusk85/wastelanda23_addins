...
namespace MarshalTest
{
    class Program
    {
        ...
        static string test = @"[[""SAVE_COMMAND"",""76561197964280320""],[[""ItemMap"",""ItemCompass"",""ItemWatch"",""NVGoggles_OPFOR"",""H_MilCap_mcamo"",""G_Tactical_Black""],[""BAF_L85A2_RIS_CWS"",["""","""",""""]],[""Colt1911"",["""","""",""""]],[""launch_B_Titan_short_F"",["""","""",""""]],[""U_B_CombatUniform_mcam"",[]],[""V_BandollierB_rgr"",[]],[""B_Carryall_cbr"",[]],[[""30Rnd_556x45_Stanag"",30],[""7Rnd_45ACP_1911"",7],[""Titan_AT"",1],[""Titan_AT"",1]],[""BAF_L85A2_RIS_CWS"",[""FullAuto""]]]]";
